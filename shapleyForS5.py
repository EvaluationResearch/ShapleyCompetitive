...
# b=[0.95487932,0.04479157,0.80758104,0.68115175,0.39437373]#test
...
def main():
    ...
    for ggg in range(0, 50):
        ...
        for ii in range(1, 51):
            ...
            c11 = random.sample(mm3, 10)
            f11 = random.sample(mm4, 10)
            ...
            # # select 8
            r11 = random.sample(mm2, 13)
            c11 = random.sample(mm3, 14)
            f11 = random.sample(mm4, 14)
            ...
            # # select 9
            r11 = random.sample(mm2, 13)
            c11 = random.sample(mm3, 22)
            f11 = random.sample(mm4, 28)
            ...
            S10M = sampleM(r11, c11, f11, mm2, mm3, mm4, RM, CM, FM, sum1M)
            S10D = sampleD(r11, c11, f11, mm2, mm3, mm4, RD, CD, FD, sum1D)
            S10R = sampleR(r11, c11, f11, mm2, mm3, mm4, RR, CR, FR, sum1R)
            S10C = sampleC(r11, c11, f11, mm2, mm3, mm4, RC, CC, FC, sum1C)
            S10H = sampleH(r11, c11, f11, mm2, mm3, mm4, RH, CH, FH, sum1H)
        ...
        workbook.save('Excel_testS53.xlsx')
