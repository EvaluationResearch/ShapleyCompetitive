...
# P=[0.95487932,0.04479157,0.80758104,0.68115175,0.39437373]#test4
P=[0.61259584,0.88131645,0.08123287,0.38380541,0.1926135]
print(P)


def findvalue():
    table = xlrd.open_workbook("16or2.xlsx")
    sheet = table.sheet_by_name("test1")
